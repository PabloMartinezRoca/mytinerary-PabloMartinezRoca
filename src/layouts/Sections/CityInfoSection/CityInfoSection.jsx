    ...
    <div className="WelcomeSection flex w-full justify-center py-24">
      <div className="flex justify-center self-center bg-black bg-opacity-40 h-[60vh] w-[75vw] max-w-[800px] rounded-3xl p-10 shadow-lg shadow-white/50">
        <div className="flex flex-col w-80 grow justify-center">
          ...
          <p className="text-white mt-12 flex justify-center self-center flex-col"><span className="text-center pb-4 text-2xl">Travel to {cityInfo.country}!</span><span className="text-center">Soon you'll find our itineraries and activities</span><span className="text-center">from this beautiful and fun city!</span></p>
